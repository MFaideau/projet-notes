                    ...
                    <tr id="orga_tr_competence_<?php echo $competence->GetId(); ?>">
                        <td>
                            <span class="orgaEdition">
                                ...
                                <a class="link" title="Lister les élèves" href="visualisation_eleve.php?listIdCompetence=<?php echo $competence->GetId(); ?>" id="orga_list_competence_<?php echo $competence->GetId(); ?>"><span class="glyphicon glyphicon-th-list icone"></span></a>
                            </span>
